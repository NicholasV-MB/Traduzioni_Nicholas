...
#Region " --- PROCESS CODE TABLE "
	...
	Private Sub Main_Group_K_4()
		...
		ActionArgs_K_139.Add("SELECT * FROM TRADS WHERE UPDATED=1") 'SelectQuery IN
		...
		'FOREACH Trad IN TradTableToUpdate
...
'----------------------------------------------------
	...
	next_iteration:
		Index_RDK_364 += 1
		If Index_RDK_364 >= MaxCount_RDK_364 then return
		goto next_foreach
	End Sub
	...
	Private Sub FOREACHLOOP_K_140()
		...
		Index_RDK_140 = 0
	next_foreach:
		Trad = CompilerUtil.Clone(Values_RDK_140(Index_RDK_140))
	...
	Private Sub FOREACHLOOP_K_2952()
		...
		Index_RDK_2952 = 0
	next_foreach:
		MetaTrad = CompilerUtil.Clone(Values_RDK_2952(Index_RDK_2952))
...
'----------------------------------------------------
	...
	Private Sub FOREACHLOOP_K_4392()
		...
		Index_RDK_4392 = 0
	next_foreach:
		_language = CompilerUtil.Clone(Values_RDK_4392(Index_RDK_4392))
	...
	Private Sub FOREACHLOOP_K_4962()
		...
		i = 1
	next_foreach:
		kvRow = CompilerUtil.Clone(Values_RDK_4962(Index_RDK_4962))
...
'----------------------------------------------------
	...
	Private Sub FOREACHLOOP_K_12532()
		...
		Index_RDK_12532 = 0
	next_foreach:
		Trad = CompilerUtil.Clone(Values_RDK_12532(Index_RDK_12532))
	...
	Private Sub FOREACHLOOP_K_12531()
		...
		Index_RDK_12531 = 0
	next_foreach:
		MetaTrad = CompilerUtil.Clone(Values_RDK_12531(Index_RDK_12531))
...
'----------------------------------------------------
	...
	Private Sub FOREACHLOOP_K_12513()
		...
		Index_RDK_12513 = 0
	next_foreach:
		_language = CompilerUtil.Clone(Values_RDK_12513(Index_RDK_12513))
