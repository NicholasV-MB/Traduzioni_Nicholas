...
Module StaticExpressions
	...
	'FOREACH Trad IN TradTableToAdd
	...
	'FOREACH MetaTrad IN MetaTradTableToUpdate
	...
	'OriginalExpression: '"SET DATEFORMAT dmy; UPDATE LANGUAGE  SET ENG='"+StrSql(Trad.ENG)+"',      ITA='"+StrSql(Trad.ITA)+"',      ESP='"+StrSql(Trad.ESP)+"',      FRA='"+StrSql(Trad.FRA)+"',      DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE TAG='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	<Extension()>
	Public Function Eval_Static_SqlStatement_K_1610(ByVal Main As RDCompiledProcess) As Object
		return "SET DATEFORMAT dmy; UPDATE LANGUAGE  SET ENG='"+StrSql(Trad.ENG)+"',      ITA='"+StrSql(Trad.ITA)+"',      ESP='"+StrSql(Trad.ESP)+"',      FRA='"+StrSql(Trad.FRA)+"',      DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE TAG='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	End Function
	...
	'OriginalExpression: '"SET DATEFORMAT dmy; UPDATE ba_properties  SET PRDESCRI_ENG='"+StrSql(Trad.ENG)+"',      PRDESCRI_ITA='"+StrSql(Trad.ITA)+"',      PRDESCRI_ESP='"+StrSql(Trad.ESP)+"',      PRDESCRI_FRA='"+StrSql(Trad.FRA)+"',      PRDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE PRCODEID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	<Extension()>
	Public Function Eval_Static_SqlStatement_K_1804(ByVal Main As RDCompiledProcess) As Object
		return "SET DATEFORMAT dmy; UPDATE ba_properties  SET PRDESCRI_ENG='"+StrSql(Trad.ENG)+"',      PRDESCRI_ITA='"+StrSql(Trad.ITA)+"',      PRDESCRI_ESP='"+StrSql(Trad.ESP)+"',      PRDESCRI_FRA='"+StrSql(Trad.FRA)+"',      PRDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE PRCODEID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	End Function
	...
	'OriginalExpression: '"SET DATEFORMAT dmy; UPDATE ba_prop_value  SET PVDESCRI_ENG='"+StrSql(Trad.ENG)+"',      PVDESCRI_ITA='"+StrSql(Trad.ITA)+"',      PVDESCRI_ESP='"+StrSql(Trad.ESP)+"',      PVDESCRI_FRA='"+StrSql(Trad.FRA)+"',      PVDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE PVPROPID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"' AND CPROWNUM="+MetaTrad.ORIGIN_ID_1
	<Extension()>
	Public Function Eval_Static_SqlStatement_K_1883(ByVal Main As RDCompiledProcess) As Object
		return "SET DATEFORMAT dmy; UPDATE ba_prop_value  SET PVDESCRI_ENG='"+StrSql(Trad.ENG)+"',      PVDESCRI_ITA='"+StrSql(Trad.ITA)+"',      PVDESCRI_ESP='"+StrSql(Trad.ESP)+"',      PVDESCRI_FRA='"+StrSql(Trad.FRA)+"',      PVDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE PVPROPID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"' AND CPROWNUM="+MetaTrad.ORIGIN_ID_1
	End Function
	...
	'OriginalExpression: '"SET DATEFORMAT dmy; UPDATE ba_activitytype SET ATDESCRI_ENG='"+StrSql(Trad.ENG)+"',      ATDESCRI_ITA='"+StrSql(Trad.ITA)+"',      ATDESCRI_ESP='"+StrSql(Trad.ESP)+"',      ATDESCRI_FRA='"+StrSql(Trad.FRA)+"',      ATDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE ATTYPEID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	<Extension()>
	Public Function Eval_Static_SqlStatement_K_1992(ByVal Main As RDCompiledProcess) As Object
		return "SET DATEFORMAT dmy; UPDATE ba_activitytype SET ATDESCRI_ENG='"+StrSql(Trad.ENG)+"',      ATDESCRI_ITA='"+StrSql(Trad.ITA)+"',      ATDESCRI_ESP='"+StrSql(Trad.ESP)+"',      ATDESCRI_FRA='"+StrSql(Trad.FRA)+"',      ATDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE ATTYPEID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	End Function
	...
	'OriginalExpression: '"SET DATEFORMAT dmy; UPDATE ba_activity_category SET ACDESCRI_ENG='"+StrSql(Trad.ENG)+"',      ACDESCRI_ITA='"+StrSql(Trad.ITA)+"',      ACDESCRI_ESP='"+StrSql(Trad.ESP)+"',      ACDESCRI_FRA='"+StrSql(Trad.FRA)+"',      ACDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE ACCATID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	<Extension()>
	Public Function Eval_Static_SqlStatement_K_2071(ByVal Main As RDCompiledProcess) As Object
		return "SET DATEFORMAT dmy; UPDATE ba_activity_category SET ACDESCRI_ENG='"+StrSql(Trad.ENG)+"',      ACDESCRI_ITA='"+StrSql(Trad.ITA)+"',      ACDESCRI_ESP='"+StrSql(Trad.ESP)+"',      ACDESCRI_FRA='"+StrSql(Trad.FRA)+"',      ACDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE ACCATID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	End Function
	...
	'OriginalExpression: '"SET DATEFORMAT dmy; UPDATE pr_item SET ITDESCRI_ENG='"+StrSql(Trad.ENG)+"',      ITDESCRI_ITA='"+StrSql(Trad.ITA)+"',      ITDESCRI_ESP='"+StrSql(Trad.ESP)+"',      ITDESCRI_FRA='"+StrSql(Trad.FRA)+"',      ITDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE ITITEMID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	<Extension()>
	Public Function Eval_Static_SqlStatement_K_2418(ByVal Main As RDCompiledProcess) As Object
		return "SET DATEFORMAT dmy; UPDATE pr_item SET ITDESCRI_ENG='"+StrSql(Trad.ENG)+"',      ITDESCRI_ITA='"+StrSql(Trad.ITA)+"',      ITDESCRI_ESP='"+StrSql(Trad.ESP)+"',      ITDESCRI_FRA='"+StrSql(Trad.FRA)+"',      ITDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE ITITEMID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	End Function
	...
	'OriginalExpression: '"SET DATEFORMAT dmy; UPDATE pr_type SET PTDESCRI_ENG='"+StrSql(Trad.ENG)+"',      PTDESCRI_ITA='"+StrSql(Trad.ITA)+"',      PTDESCRI_ESP='"+StrSql(Trad.ESP)+"',      PTDESCRI_FRA='"+StrSql(Trad.FRA)+"',      PTDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE PTTYPEID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	<Extension()>
	Public Function Eval_Static_SqlStatement_K_2497(ByVal Main As RDCompiledProcess) As Object
		return "SET DATEFORMAT dmy; UPDATE pr_type SET PTDESCRI_ENG='"+StrSql(Trad.ENG)+"',      PTDESCRI_ITA='"+StrSql(Trad.ITA)+"',      PTDESCRI_ESP='"+StrSql(Trad.ESP)+"',      PTDESCRI_FRA='"+StrSql(Trad.FRA)+"',      PTDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE PTTYPEID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	End Function
	...
	'OriginalExpression: '"SET DATEFORMAT dmy; UPDATE dm_class SET CDDESCRI_ENG='"+StrSql(Trad.ENG)+"',      CDDESCRI_ITA='"+StrSql(Trad.ITA)+"',      CDDESCRI_ESP='"+StrSql(Trad.ESP)+"',      CDDESCRI_FRA='"+StrSql(Trad.FRA)+"',      CDDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE CDCLASSID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	<Extension()>
	Public Function Eval_Static_SqlStatement_K_2593(ByVal Main As RDCompiledProcess) As Object
		return "SET DATEFORMAT dmy; UPDATE dm_class SET CDDESCRI_ENG='"+StrSql(Trad.ENG)+"',      CDDESCRI_ITA='"+StrSql(Trad.ITA)+"',      CDDESCRI_ESP='"+StrSql(Trad.ESP)+"',      CDDESCRI_FRA='"+StrSql(Trad.FRA)+"',      CDDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE CDCLASSID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	End Function
	...
	'OriginalExpression: '"SET DATEFORMAT dmy; UPDATE dm_folder_001  SET DMDESCRI_ENG='"+StrSql(Trad.ENG)+"',      DMDESCRI_ITA='"+StrSql(Trad.ITA)+"',      DMDESCRI_ESP='"+StrSql(Trad.ESP)+"',      DMDESCRI_FRA='"+StrSql(Trad.FRA)+"',      DMDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE DMDESCRI='"+StrSql(MetaTrad.ORIGIN_ID_0)+"' AND DMTYPE='C'"
	<Extension()>
	Public Function Eval_Static_SqlStatement_K_3441(ByVal Main As RDCompiledProcess) As Object
		return "SET DATEFORMAT dmy; UPDATE dm_folder_001  SET DMDESCRI_ENG='"+StrSql(Trad.ENG)+"',      DMDESCRI_ITA='"+StrSql(Trad.ITA)+"',      DMDESCRI_ESP='"+StrSql(Trad.ESP)+"',      DMDESCRI_FRA='"+StrSql(Trad.FRA)+"',      DMDESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE DMDESCRI='"+StrSql(MetaTrad.ORIGIN_ID_0)+"' AND DMTYPE='C'"
	End Function
	...
	'OriginalExpression: '"SET DATEFORMAT dmy; UPDATE ba_source SET SODESCRI_ENG='"+StrSql(Trad.ENG)+"',      SODESCRI_ITA='"+StrSql(Trad.ITA)+"',      SODESCRI_ESP='"+StrSql(Trad.ESP)+"',      SODESCRI_FRA='"+StrSql(Trad.FRA)+"',      SODESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE SOID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	<Extension()>
	Public Function Eval_Static_SqlStatement_K_2689(ByVal Main As RDCompiledProcess) As Object
		return "SET DATEFORMAT dmy; UPDATE ba_source SET SODESCRI_ENG='"+StrSql(Trad.ENG)+"',      SODESCRI_ITA='"+StrSql(Trad.ITA)+"',      SODESCRI_ESP='"+StrSql(Trad.ESP)+"',      SODESCRI_FRA='"+StrSql(Trad.FRA)+"',      SODESCRI_DEU='"+StrSql(Trad.DEU)+"',      cpupdtms='"+DateToStr(Now())+"' WHERE SOID='"+StrSql(MetaTrad.ORIGIN_ID_0)+"'"
	End Function
	...
	'FOREACH _language IN Languages
	...
	'FOREACH Trad IN TradTableToDelete
	...
	'FOREACH MetaTrad IN MetaTradTableToDelete
